...
#ifndef EDGEPANELMOBILE_SWIFT_H
#define EDGEPANELMOBILE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="EdgePanelMobile",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15EdgePanelMobile12PushDelegate")
@interface PushDelegate : NSObject <UIApplicationDelegate, UNUserNotificationCenterDelegate>
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC15EdgePanelMobile9ScannerVC")
